...
<br><br>
<br><br>
<center><h3 class="text-primary">INICIAR SESIÓN <br><svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-key-fill" viewBox="0 0 16 16">
...
<center>
    ...
    <label for="formGroupExampleInput" class="text-primary">USUARIO</label>
    <input type="text" class="form-control" name="usuario" id="formGroupExampleInput" placeholder="Usuario">
  </div><br>
  <div class="form-group">
    <label for="formGroupExampleInput" class="text-primary">CONTRASEÑA</label>
